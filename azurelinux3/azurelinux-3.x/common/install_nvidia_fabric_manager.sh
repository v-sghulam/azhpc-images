...
tdnf install -y <pcakage-url>  nvidia-fabric-manager-560.35.03-2.azl3.x86_64.rpm
tdnf install -y <pcakage-url>  nvidia-fabric-manager-devel-560.35.03-2.azl3.x86_64.rpm
