...
tdnf install -y /home/packer/azurelinux-hpc/prebuilt/subunit-1.4.4-5.azl3.x86_64.rpm
tdnf install -y /home/packer/azurelinux-hpc/prebuilt/subunit-devel-1.4.4-5.azl3.x86_64.rpm


## Install libmd and libmd-devel 
tdnf install -y /home/packer/azurelinux-hpc/prebuilt/libmd-1.1.0-6.azl3.x86_64.rpm
tdnf install -y /home/packer/azurelinux-hpc/prebuilt/libmd-devel-1.1.0-6.azl3.x86_64.rpm
