...
tdnf -y install https://repo.radeon.com/amdgpu-install/6.4/azurelinux/3.0/amdgpu-install-6.4.60400-1.azl3.noarch.rpm --nogpgcheck 
...
baseurl=https://repo.radeon.com/rocm/azurelinux3/6.4/main/
enabled=1
repo_gpgcheck=0
gpgcheck=0
sslverify=0
