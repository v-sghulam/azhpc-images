...
#                 rdma-core \
#                 rdma-core-devel \
#                 https://packages.microsoft.com/azurelinux/3.0/prod/base/x86_64/Packages/m/mlnx-ofa_kernel-24.10-6.azl3.x86_64.rpm \
#                 https://packages.microsoft.com/azurelinux/3.0/prod/base/x86_64/Packages/m/mlnx-ofa_kernel-modules-24.10-6.azl3.x86_64.rpm \
#                 https://packages.microsoft.com/azurelinux/3.0/prod/base/x86_64/Packages/m/mlnx-ofa_kernel-devel-24.10-6.azl3.x86_64.rpm \
#                 https://packages.microsoft.com/azurelinux/3.0/prod/base/x86_64/Packages/m/mlnx-ofa_kernel-source-24.10-6.azl3.x86_64.rpm \
#                 https://packages.microsoft.com/azurelinux/3.0/prod/base/x86_64/Packages/m/mft_kernel-4.30.0-13.azl3.x86_64.rpm \
#                 mstflint \
#                 https://packages.microsoft.com/azurelinux/3.0/prod/base/x86_64/Packages/f/fwctl-24.10-6.azl3.x86_64.rpm  \
#                 ibacm \
#                 ibarr \
#                 ibsim \
#                 https://packages.microsoft.com/azurelinux/3.0/prod/base/x86_64/Packages/i/iser-24.10-6.azl3.x86_64.rpm \
#                 https://packages.microsoft.com/azurelinux/3.0/prod/base/x86_64/Packages/i/isert-24.10-6.azl3.x86_64.rpm \
...
#                 mlnx-ethtool \
#                 mlnx-iproute2 \
#                 https://packages.microsoft.com/azurelinux/3.0/prod/base/x86_64/Packages/m/mlnx-nfsrdma-24.10-6.azl3.x86_64.rpm \
#                 multiperf \
#                 https://packages.microsoft.com/azurelinux/3.0/prod/base/x86_64/Packages/s/srp-24.10-6.azl3.x86_64.rpm \
#                 srp_daemon \
#                 ucx \
#                 ucx-cma \
#                 ucx-devel \
